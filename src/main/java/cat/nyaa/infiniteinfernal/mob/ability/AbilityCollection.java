...
public class AbilityCollection {
    ...
    static {
        ACTIVE_CLASSES = ClassPathUtils.scanSubclasses(InfPlugin.plugin, "cat.nyaa.infiniteinfernal.mob.ability.impl.active", IAbility.class);
        PASSIVE_CLASSES = ClassPathUtils.scanSubclasses(InfPlugin.plugin, "cat.nyaa.infiniteinfernal.mob.ability.impl.passive", IAbility.class);
