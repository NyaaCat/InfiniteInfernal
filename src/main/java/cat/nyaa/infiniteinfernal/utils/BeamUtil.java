...
public class BeamUtil {
    ...
    private static class MovingTask extends BukkitRunnable {
        ...
        private void spawnParticle(LivingEntity from, World world, Location lastLocation, int i) {
            ...
            world.spawnParticle(beamConfig.particle.type, lastLocation, i, beamConfig.particle.getOffsetX(), beamConfig.particle.getOffsetY(), beamConfig.particle.getOffsetZ(), beamConfig.particle.speed, Utils.parseExtraData(beamConfig.particle), beamConfig.particle.forced);
        }
