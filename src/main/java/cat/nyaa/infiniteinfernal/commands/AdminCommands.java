...
import cat.nyaa.infiniteinfernal.mob.ability.AbilityCollection;
...
public class AdminCommands extends CommandReceiver {
    ...
    public void onToggleUi(CommandSender sender, Arguments arguments) {
        ...
        boolean enableActionbarInfo = config.enableActionbarInfo;
        config.enableActionbarInfo = !enableActionbarInfo;
        config.save();
    }
    ...
    private static List<String> filtered(String lastArg, List<String> completeStr) {
        return completeStr.stream().filter(s -> s.startsWith(lastArg)).collect(Collectors.toList());
    }

    private static List<String> filtered(List<String> excluded, String lastArg, List<String> completeStr) {
        return completeStr.stream().filter(s -> s.startsWith(lastArg))
